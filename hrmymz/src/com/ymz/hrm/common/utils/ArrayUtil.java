...
public class ArrayUtil {
     ...
     *
     * @param values Values to get the unique of.  Note that this
     *               array _must_ be sorted, prior to invoking this method
     * 
     * @return a new array with values represented in the 'values' 
     *         argument only a single time each
     */
    ...
    /**
     * Array equality
     * @return true if both arrays contain elements in the same
     * positions that are also equal.  Returns false if either (or both) arrays 
     * are null;
     */
    public static boolean equals (Object[] a1, Object[] a2) {
        ...
        for (int i=0; i<a1.length; i++) {
            ...
            } else if (a2[i] == null) return false;
     ...
     * In the case of a tie, the earlier value in the array will
     * be returned.
     *
     * Ex:  findMinDiff({1, 2, 3, 4, 5})      -> 0 
     *      findMinDiff({1, 2, 2.2, 3, 4, 5}) -> 1
     * 
     * @param values An array of _sorted_, _unique_ values
     *
     * @return The index of the first number in the pair with the 
     *         smallest difference.
     */
    ...
    /**
     * Convert a string array to an array of Integer.  If
     * <code>array</code> is null, null will be returned.
     *
     * @param array string array
     * @return the Integer array
     * @throws NumberFormatException if an element in the String array
     * is not parseable into an Integer
     */
    ...
    /**
     * Convert a string array to an array of int.  If 
     * <code>array</code> is null, null will be returned.
     *
     * @param array string array
    ...
    /**
     * Combine two arrays into a single, larger array.  This method only
     * returns null if both a1 and a2 are null.  If a1 is not null, the array
     * that is returned has the same class as a1.  Otherwise it will be the
     * the same class as a2.
     * @param a1 The first array.  If this is null, a copy of the second array 
     * is returned (unless it's null too, then null is returned).
     * @param a2 The second array.  If this is null, a copy of the first array 
     * is returned (unless it's null too, then null is returned).
     * @return An array that is effectively a2 appended to a1, or null if both
     * a1 and a2 are null.  The class of the array is the same as a1, unless 
     * a1 is null in which case the class of the array is the same as a2, unless
