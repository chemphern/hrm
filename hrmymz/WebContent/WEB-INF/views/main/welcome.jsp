...
<link rel="stylesheet" href="${res }/main/home.css" />
...
<div class="article toolbar">
    ...
    <div class="content">
    	<ul class="toollist ue-clear">
    		<li>
            	<a href="javascript:;" class="img"><img src="${res}/images/icon01.png" /></a>
                <p><a href="javascript:;">通知公告</a></p>
            </li>
            <li>
            	<a href="javascript:;" class="img"><img src="${res}/images/icon02.png" /></a>
                <p><a href="javascript:;">下载中心</a></p>
            </li>
            <li>
            	<a href="javascript:;" class="img"><img src="${res}/images/icon03.png" /></a>
                <p><a href="javascript:;">密码修改</a></p>
            </li>
            <li>
            	<a href="javascript:;" class="img"><img src="${res}/images/icon09.png" /></a>
                <p><a href="javascript:;">系统配置</a></p>
            </li>
            <li class="add-btn">
            	<img src="${res }/images/add.png" />
            </li>
    	</ul>
